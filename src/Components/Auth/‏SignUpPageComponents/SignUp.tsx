...
const SignUp = () => {
  ...
  const handleSignUp = (event: FormEvent) => {
    ...
    axios
      .post("https://web-production-3ca4c.up.railway.app/api/register", formData, {
  ...
  return (
    <Container fluid className="d-flex justify-content-center align-items-center min-vh-100 signup-container">
      <Row className="w-100 justify-content-center">
        <Col xs={12} md={6} lg={4}>
          <Card className="p-4 shadow login-signup-card signup-card">
            <Card.Body className="d-flex flex-column align-items-center ">
              <div className="mb-4 d-flex justify-content-center align-items-center login-logo signup-logo">
